...
public class CompletionQueryActivity extends BaseTransactionQueryActivity{

	private ListGrid mGrid;

	private CompletionInfoDao mDao;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDao = CompletionInfoDao.getInstance(this);
	}
	...
	protected void query() {
		...
		try {
			...
			List<CompletionInfo> list = mDao.onQuery()
					.whereClause()
			...
			ToastHelper.getInstance(CompletionQueryActivity.this).show(e.getMessage());
		}
	}
}
